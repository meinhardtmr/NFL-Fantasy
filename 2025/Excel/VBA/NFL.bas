...
With ws
    ...
    For i = 2 To .Cells(Rows.Count, 15).End(xlUp).row
        .Cells(i, 20).Value = .Cells(i, 2) & ":" & .Cells(i, 11) & IIf(.Cells(i, 13) <> "", " " & .Cells(i, 13), "")
    Next i
                            ...
                            WorksheetFunction.Sum(teamCnt) < 6 Then
                                For n = 1 To pnum
                                    Select Case n
                                        ...
                                        Case 3
                                            nArr = Array(2, 0, 1, 3, 4, 5)
                                        Case 4
                                            nArr = Array(3, 0, 1, 2, 4, 5)
                                        Case 5
                                            nArr = Array(4, 0, 1, 2, 3, 5)
                                        Case 6
                                            nArr = Array(5, 0, 1, 2, 3, 4)
                                    End Select
